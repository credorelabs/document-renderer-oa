...
import { Invoice } from "../new-invoice/types";
export const commercialInvoiceTemplate: Invoice = {
  recipient: {
    ...
    supplierContactEmail: "supplier@email.com",
    supplierContactPhone: "123-456-7890",
    supplierAddress: "123 Supplier St, Supplier City",
    supplierVat: "IN1234567890123Z1",
    ...
    customerContactEmail: "customer@email.com",
    customerContactName: "Customer Contact",
    customerPhoneNumber: "999999999",
    customerAddress: "456 Customer Ave, Customer City",
    leiNum: 'ASDFGHJKLUYTREFDGHJ',
    customerVat: "GB123456789",
    ...
    selectedBank: {
      ...
      country: "India",
      currency: "INR",
      accountId: "88499937563937",
      bank_name: "ICICI Bank",
      branch_name: "Patia Branch",
      account_holder: "Kristina",
      branch_address: "Patia, Bhubaneswar",
    },
    Invoice_Lines: [
      {
