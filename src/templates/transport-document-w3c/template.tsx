...
export const W3CCargoDocumentTemplate = (props: TemplateProps<any>) => {
  const w3cDocument = props.document as W3CCargoDocument;
  const cargoDocument = adaptW3CDocument(w3cDocument);

  return <CargoDocumentTemplate document={cargoDocument} handleObfuscation={props.handleObfuscation} />;
};
